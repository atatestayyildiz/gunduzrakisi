...
export const Book = ({
  ...
  const resolvedTextColor = textColor || (variant === "stripe" ? "var(--ds-gray-1000)" : "#ffffff");

  return (
    <div
      className={clsx("inline-block w-fit cursor-pointer select-none", className)}
      ...
      >
        ...
        >
          {coverImage ? (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex flex-col justify-end p-[7%] pl-[14%]">
                <span
